export const ALGORITHM_KEYWORDS = [
  ...
  { id: 't1_4', name: '公開轉發', tier: 1, synonyms: ['轉發', '公開分享', '限時動態分享', '轉貼', '分享率'] },
  { id: 't1_5', name: '收藏數', tier: 1, synonyms: ['收藏', '儲存', '先存起來', '收藏次數'] },
  { id: 't1_6', name: '點進主頁', tier: 1, synonyms: ['點大頭貼', '看主頁', '進個人頁', '點進個人檔案'] },
  { id: 't1_7', name: '熱烈討論', tier: 1, synonyms: ['留言很多', '討論熱絡', '大量留言', '留言互動', '互動率', '互動數'] },
  { id: 't1_8', name: '認真留言', tier: 1, synonyms: ['長留言', '深度留言', '留言分享心得', '高品質留言'] },
  { id: 't1_9', name: '連續觀看', tier: 1, synonyms: ['接著看下一篇', '連看', '持續看下去', '看完又看'] },
  { id: 't1_10', name: '剛發布的熱度', tier: 1, synonyms: ['前幾小時爆量', '首發熱度', '剛發就很多人看', '早期熱度', '新鮮度'] },
  { id: 't1_11', name: '穩定觀看', tier: 1, synonyms: ['持續觀看', '沒有滑走', '不跳出', '觀看穩定', '跳出率', '留存率'] },
  ...
  { id: 't1_16', name: '觀看數量', tier: 1, synonyms: ['觀看數', '瀏覽數', '觀看量', 'view數', '點閱數', 'view count'] },
  { id: 't1_17', name: '流量', tier: 1, synonyms: ['曝光量', '觸及量', '流量高', '導流', '曝光', '觸及', '觸及率'] },
  { id: 't1_18', name: '點擊率', tier: 1, synonyms: ['ctr', '點閱率', '點擊率高', '點開率', '點擊'] },

  // Tier 2: 讓 AI 與搜尋引擎看懂你的關鍵
  { id: 't2_1', name: '前三秒抓眼球', tier: 2, synonyms: ['前3秒吸睛', '開頭吸睛', '一開始就抓人', '開場抓眼球', '鉤子', 'hook'] },
  ...
  { id: 't2_5', name: '畫面與聲音清晰', tier: 2, synonyms: ['畫質好', '收音清楚', '聲音清楚', '不模糊', '高畫質', '音質清楚'] },
  { id: 't2_6', name: '第一手經驗', tier: 2, synonyms: ['親身經驗', '自己去過', '自己用過', '自己吃過'] },
  { id: 't2_7', name: '展現專業感', tier: 2, synonyms: ['專業', '內行細節', '專家感', '專業度'] },
  { id: 't2_8', name: '直接給答案', tier: 2, synonyms: ['先講重點', '先給答案', '開頭先破題', '先說結論', '直接破題'] },
  { id: 't2_9', name: '精準長尾字', tier: 2, synonyms: ['長尾關鍵字', '精準關鍵字', '細部搜尋字', '長尾字', '關鍵字', 'keyword'] },
  { id: 't2_10', name: '語氣客觀中立', tier: 2, synonyms: ['客觀', '中立', '理性敘述', '客觀語氣'] },
  { id: 't2_11', name: '有附上來源', tier: 2, synonyms: ['附來源', '引用來源', '有連結', '有資料來源'] },
  { id: 't2_12', name: '有圖解輔助', tier: 2, synonyms: ['圖表說明', '圖解', '視覺化輔助', '圖片說明', '資訊圖表'] },
  ...
  { id: 't2_15', name: '話說得清楚', tier: 2, synonyms: ['表達清楚', '句型簡單', '說明明確', '好理解', '使用者體驗', '閱讀體驗'] },
  { id: 't2_16', name: '搜尋排名', tier: 2, synonyms: ['排名', 'google排名', 'seo排名', '搜尋結果排名', '排名靠前'] },
  { id: 't2_17', name: '點擊進站', tier: 2, synonyms: ['進站點擊', '導入網站', '點進網站', '進站流量'] },
  { id: 't2_18', name: '轉換率', tier: 2, synonyms: ['轉化率', 'conversion rate', '成交率', '轉單率'] },
  { id: 't2_19', name: '網站速度', tier: 2, synonyms: ['頁面速度', '載入速度', '網站載入速度', 'page speed'] },
  { id: 't2_20', name: '行動裝置友善', tier: 2, synonyms: ['mobile friendly', '手機友善', '手機版友善', '行動版友善'] },
  { id: 't2_21', name: '內部連結', tier: 2, synonyms: ['internal link', '站內連結', '內鏈', '文章互連'] },
  { id: 't2_22', name: '關鍵字密度', tier: 2, synonyms: ['keyword density', '關鍵詞密度', '關鍵字配置', '關鍵字佈局'] },
  { id: 't2_23', name: '更新頻率', tier: 2, synonyms: ['更新速度', '固定更新頻率', '內容更新頻率', '更新週期'] },

  // Tier 3: 把帳號養大的長期指標
  { id: 't3_1', name: '別的大帳號推薦你', tier: 3, synonyms: ['大帳號推薦', '網紅推薦', '權威標記', '被大帳號轉發'] },
  { id: 't3_2', name: '別的網站連到你', tier: 3, synonyms: ['外部連結', '被轉載', '反向連結', '媒體引用', 'backlink', '外鏈'] },
  ...
  { id: 't3_10', name: '老粉絲常回來', tier: 3, synonyms: ['回訪率高', '老粉回流', '粉絲常回來看', '忠誠觀眾', '回訪率', '回流率'] },
